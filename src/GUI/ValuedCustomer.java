...
public class ValuedCustomer extends JPanel {
	...
	private JButton updateButton, addJobButton, backButton, discountPlanButton;
	...
	public ValuedCustomer(int width, int height, String[] customerData, GUI f) {
		...
		updateButton.setBounds((width / 2) - (width / 8) - 139, (height / 2 + height / 5), 139, 29);
		add(updateButton);
		...
		addJobButton.setBounds((width / 2) + (width / 8), (height / 2 + height / 5), 139, 29);
		add(addJobButton);
		...
		discountPlanButton.setBounds((width / 2) - 75, (height / 2 + height / 5), 150, 29);
		add(discountPlanButton);
