...
public interface I_UserAccountTransaction extends Transaction {
    ...
    UserAccount create(String name, String email, String phone, String password, String role, String department) throws SQLException;
    UserAccount update(int id, String name, String email, String phone, String password, String role) throws SQLException;
    UserAccount update(int id, String name, String email, String phone, String password, String role, String department) throws SQLException;
