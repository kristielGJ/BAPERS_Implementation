...
public class Job {
	...
	/**
	 * save the job details in the model.database
	 *
	 * @param job_desc
	 * @param priority
	 * @param completion_deadline
	...
	/**
	 * retrieving the job details from the model.database
	 *
	 * @param job_ID
	 */
	...
	/**
	 * updating the job status in the model.database
	 *
	 * @param job_ID
	 * @param job_status
	 */
	...
	/**
	 * updating the priority level in the model.database
	 *
	 * @param job_ID
	 * @param priority
	 */
	...
	/**
	 * adding the completion_time of the job in the model.database
	 *
	 * @param job_ID
	 */
	...
	/**
	 * adding the payment deadline in the model.database for valued model.customers
	 *
	 * @param job_ID
	 * @param payment_deadline
	 */
