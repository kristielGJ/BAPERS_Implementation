...
public class ExistingTasksList {

	private int numOfExistingTasks = 30;

	/**
	 * 
	 * @param task_data
	 */
	public boolean extendTaskList(String task_data) {
	...
	public ExistingTasksList() {
		// TODO - implement ExistingTasksList.ExistingTasksList
		throw new UnsupportedOperationException();
	}
